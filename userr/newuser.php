                                ...
                                <form class='horizontal'class='user' method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
                                    <div class="row"> 
                                            <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name='username' class="form-control" id="exampleInputEmail1" aria-describedby="coyHelp" placeholder="Enter Username">
                                                        </div>
                                    ...
                                    <div class="row"> 
                                            <div class="form-group col-md-6">
                                                            ...
                                                            <input type="password" name='password' class="form-control" id="exampleInputEmail1" aria-describedby="coyHelp" placeholder="Enter Password">
                                                        </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name='userphone' class="form-control" id="exampleInputEmail1" aria-describedby="nameHelp" placeholder="Enter Admin phone number">
                                                        </div>
                                    </div>
                                ...
                                <!-- Validation-->
                                    <?php
                                        if (isset($_POST['submit'])){
                                            ...
                                            mysqli_query($con,"INSERT INTO users(username,password,email,userphone,bankname,accountnum,reg_date,role) VALUES('$username','$password','$user_email','$userphone','$bankname','$accountnum','$today','Admin') ");
                                            echo '<script type="text/javascript">';
                         
                                            echo 'setTimeout(function () { swal("Success!","Admin created succesfully!","success");';
