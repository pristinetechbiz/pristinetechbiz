                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Deactivated list of Artists</h5>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if(isset($_POST['sbmt1'])){
                                                            ...
                                                            if($_POST['plan'] == 'single'){
                        									        $sn = 0;
                                                    									  $sql = mysqli_query($con," SELECT * from users WHERE plan is NULL AND status = '0' AND role = 'user' ");
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                         ...
                                                                                         <a href='#' class='btn btn-danger'>Activate Artist</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                         "; }
